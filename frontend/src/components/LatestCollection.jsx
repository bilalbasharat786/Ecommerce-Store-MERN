...
const LatestCollection = () => {
  ...
  return (
    <section className="w-full py-16 sm:py-24 bg-[#FAFAFA] overflow-hidden">
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
        
        {/* Header Section (Stable without motion wrapper) */}
        ...
        {/* Product Grid (Direct render to avoid Opacity 0 bug) */}
