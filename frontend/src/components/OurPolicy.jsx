  ...
  return (
    <div className="flex flex-col sm:flex-row justify-around items-center gap-8 sm:gap-4 md:gap-2 text-center py-10 sm:py-16 md:py-20 text-[10px] sm:text-sm md:text-base text-gray-700 px-4">
      <div className="flex flex-col items-center w-[80%] sm:w-auto">
       <img src={assets.exchange_icon} alt="exchange_icon" className="w-10 sm:w-12 md:w-14 m-auto mb-3 sm:mb-5" />
      ...
      <div className="flex flex-col items-center w-[80%] sm:w-auto">
       <img src={assets.quality_icon} alt="quality_icon" className="w-10 sm:w-12 md:w-14 m-auto mb-3 sm:mb-5" />
      ...
      <div className="flex flex-col items-center w-[80%] sm:w-auto">
       <img src={assets.support_img} alt="support" className="w-10 sm:w-12 md:w-14 m-auto mb-3 sm:mb-5" />
